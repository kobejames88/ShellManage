package com.shell.manage.utils;
...
public class ShellConfig {
    ...
    // 懒汉式,线程安全,适合多线程
    public static synchronized ShellConfig getInstance2() {
        if (shellConfig == null) {
            shellConfig = new ShellConfig();
        }
        return shellConfig;
    ...
    private static String ipAddress = "192.168.48.130";// ip地址
     ...
     * @param password
     */
    public ShellConfig(String ipAddress, String userName, String password) {
     ...
     * 84
     */
    public ShellConfig(String ipAddress, int port, String userName, String password) {
        super();
